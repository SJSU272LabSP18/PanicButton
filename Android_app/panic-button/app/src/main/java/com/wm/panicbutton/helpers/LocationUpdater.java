...
public class LocationUpdater {
    ...
    public LocationUpdater(Context context) {
        ...
        //ENTERED BY RACHIT
//        latitude = lm.getLastKnownLocation(lm.NETWORK_PROVIDER).getLatitude();
//        longitude = lm.getLastKnownLocation(lm.NETWORK_PROVIDER).getLongitude();
//        requestGeocode();
    }
    ...
    private void UpdateLocation() {
        String latlng = latitude + "," + longitude;
        String url = "https://nrupatest1.mybluemix.net/log?lat=" + latitude + "&long=" + longitude + "&sev=4";
        Log.i(TAG, "Bluemix location update url: " + url);
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
